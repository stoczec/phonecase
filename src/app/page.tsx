		...
		<div className='bg-slate-50'>
			<section>
				<MaxWidthWrapper className='pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-32 lg:pb-52'>
					<div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
						<div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
							<div className='absolute w-28 left-0 -top-20 hidden lg:block'>
								<img src='/lizard-1.png' alt='Logo' className='w-full' />
							</div>
							...
							<ul className='mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start'>
								<div className='space-y-2'>
									<li className='flex gap-1.5 items-center text-left'>
										<Check className='h-5 w-5 shrink-0 text-blue-600'></Check>
										High-quality, durable material
									</li>
									<li className='flex gap-1.5 items-center text-left'>
										<Check className='h-5 w-5 shrink-0 text-blue-600'></Check>5
					...
					<div className='col-span-full lg:col-span-1 flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20'>
						<div className='relative md:max-w-xl'>
							<img
								className='absolute w-40 lg:w-52 left-52 -top-20 select-none hidden sm:block lg:hidden xl:block'
								src='/templates/your-image.png'
								alt='your image'
							/>
							<img
								className='absolute w-20 -left-6 -bottom-6 select-none'
								src='/templates/line.png'
								alt='line'
							/>
